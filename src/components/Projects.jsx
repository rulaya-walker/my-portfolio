...
const Projects = () => {
  ...
  return (
    <section className='px-6 py-10' id="work">
        <h1 className='text-4xl md:text-6xl font-medium tracking-tight mb-4'>Work</h1>
                ...
                >
                    ...
                    <div className='relative z-20 p-6 flex flex-col justify-between h-full bg-black/50 text-white'>
                        ...
                        <div className='flex flex-col justify-between'>
                            ...
                            <a href={project.link} target="_blank" rel="noopener noreferrer" className='bg-white text-stone-900 rounded-full py-2 px-2 w-32 text-sm hover:bg-gray-100 text-center cursor-pointer'>
                                View Project
                            </a>
                        </div>
                    </div>
